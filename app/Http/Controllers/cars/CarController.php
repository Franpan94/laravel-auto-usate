...
class CarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cars.cars.show', compact('car'))->with('session', $car->brand . ' ' . $car->model . ' è stato aggiunto.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('cars.cars.show', compact('car'))->with('session', $car->brand . ' ' . $car->model . ' è stato modificato.');
    }
    ...
    public function destroy($id)
    {
        $car = Car::findOrFail($id);
        $car->delete();
        return redirect()->route('cars.cars.index')->with('delete', $car->brand . ' ' . $car->model . ' è stato cancellato.');
    }
}
